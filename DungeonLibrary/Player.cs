        ...
        public string RaceDescription()
        {
            ...
            switch (CharacterRace)
            {
                case Race.miqote:
                    ...
                    break;
                case Race.viera:
                    desc = "Introduced in Shadowbringers, the Viera were originally female only. Male Viera were added with Endwalker." +
                        " They are a superficially leporine race, with long fur-covered ears and lithe features. Viera are " +
                        "divided into Rava and Veena clans.";
                    break;
                case Race.aura:
